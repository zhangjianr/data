...
#config_form .up_mp3{margin-top:5px;}
#config_form .up_mp3 .up_input{float:left; width:130px;}
#config_form .up_mp3 .tips{height:30px; line-height:30px; float:left;}
</style>
<div id="iframe_page">
    ...
    <div class="r_con_config r_con_wrap">
      <form action="config.php" method="post" id="config_form">
	    <table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
                <td width="50%" valign="top">
                    <h1><span class="fc_red">*</span><strong>微信支付商户证书</strong><span class="tips">（apiclient_cert.pem）</span></h1>
					<input type="text" class="input" id="CertPath" name="CertPath" value="<?php echo empty($rsPay["PaymentWxpayCert"])?"":$rsPay["PaymentWxpayCert"] ?>" maxlength="500" notnull />
					<div class="up_mp3"> <span class="up_input">
					<input id="CertUpload" name="CertUpload" type="file">
					</span></div>
                </td>
                <td width="50%" valign="top">
					<h1><span class="fc_red">*</span><strong>微信支付证书密钥</strong><span class="tips">（apiclient_key.pem）</span></h1>
					<input type="text" class="input" id="KeyPath" name="KeyPath" value="<?php echo empty($rsPay["PaymentWxpayKey"])?"":$rsPay["PaymentWxpayKey"] ?>" maxlength="500" notnull />
					<div class="up_mp3"> <span class="up_input">
