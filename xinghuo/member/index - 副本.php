...
if (isset($_SESSION['user_type'])) {
	...
	foreach ($employee_right as $key => $val) {
		foreach ($val as $k => $v) {
			...
			if (in_array($key, array('kanjia', 'zhuli', 'hongbao', "spark"))) {
		...
		<div id="main" >
			<div class="menu" >
				<dl>
					...
					<dt group="spark">星火燎原</dt>
					<dd>
						<div><a href="/member/spark/config.php" target="iframe">基本设置</a></div>
						<div><a href="/member/spark/package.php" target="iframe">套餐管理</a></div>
						<div><a href="/member/spark/slide.php" target="iframe">幻灯管理</a></div>
						<div><a href="/member/spark/order.php" target="iframe">订单管理</a></div>
                        <div><a href="/member/spark/rebate.php" target="iframe">返佣管理</a></div>
						<div><a href="/member/spark/traffic.php" target="iframe">流量包管理</a></div>
					...
					<dd>
						...
						<div><a href="/member/shop/channel.php" target="iframe">渠道设置</a></div>
					...
					<dt group="pifa">商品批发</dt>
					<dd>
						<div><a href="/member/pifa/config.php" target="iframe">基本设置</a></div>
						<div><a href="/member/pifa/products.php" target="iframe">商品管理</a></div>
						<div><a href="/member/pifa/category.php" target="iframe">商品分类</a></div>
						<div><a href="/member/pifa/commit.php" target="iframe">商品评论</a></div>
						<div><a href="/member/pifa/orders.php" target="iframe">订单管理</a></div>
					</dd>
...
<?php endif; ?>
					...
					<dd>
						...
						<div><a href="/member/user/integral_rule.php" target="iframe">积分规则设置</a></div>
