...
<div class="login_box">
  <div class="tab_box">
    <h2 onclick="window.location.href='/member/findpwd.php';">找回密码</h2>
    <div class="clear"></div>
    <div class="reg_con tab_con_2">
	<?php if($step==0){?>
      <form>
	    <input type="text" name="Users_Account" value="" class="name" placeholder="用户名"  />
		<input type="submit" value="下一步" class="reg_btn">
      </form>
	<?php }elseif($step==1){?>
	  <form>
	    <input type="text" disabled="disabled" value="<?php echo $rsUsers["Users_Account"];?>" class="name" placeholder="用户名"  />
		<input type="text" readonly="readonly" name="Users_Mobile" value="<?php echo $rsUsers["Users_Mobile"];?>" class="mobile" id="mobile" />
		<p><button id="sendsms">发送短信</button><input type="text" name="sms_code" value="" placeholder="短信验证码" class="smscode"/><div class="clear"></div></p>
		<input type="password" name="Users_PasswordA" value="" class="password" placeholder="新密码" />
		<input type="password" name="Users_PasswordB" value="" class="password" placeholder="确认密码"  />
