        ...
        <tbody>
          <?php
			...
			foreach($lists as $k=>$v){
				$item = $DB->GetRs("user_order","count(*) as num,sum(Order_TotalPrice) as amount","where Order_Type='zhongchou_".$v["itemid"]."' and Users_ID='".$_SESSION["Users_ID"]."' and Order_Status=2");
