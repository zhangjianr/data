...
function get_title($itemid){
	global $DB;
	$r = $DB->GetRs("pifa_products","*","where Products_ID='".$itemid."'");
    ...
    <div id="reviews" class="r_con_wrap">
      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table" id="review_list">
        ...
        <tbody>
         <?php
		  $lists = array();
		  $DB->getPage("user_order_commit","*","where Users_ID='".$_SESSION["Users_ID"]."' and MID='pifa' order by CreateTime desc",10);
