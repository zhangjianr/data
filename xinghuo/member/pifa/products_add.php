...
?>
				...
				<div class="rows">
					...
					<table id="wholesale_price_list" class="item_data_table" border="0" cellpadding="3" cellspacing="0">
						<tr>
							<td>一级&nbsp;&nbsp;%
								<input name="Distribute[0]" value="" class="form_input" size="5" maxlength="10" type="text">
								(产品利润的百分比) </td>
						<tr>
							<td>二级&nbsp;&nbsp;%
								<input name="Distribute[1]" value="" class="form_input" size="5" maxlength="10" type="text">
								(产品利润的百分比) </td>
						</tr>
						<tr>
							<td>三级&nbsp;&nbsp;%
								<input name="Distribute[2]" value="" class="form_input" size="5" maxlength="10" type="text">
								(产品利润的百分比) </td>
						</tr>
							</tr>
