...
if($_POST){
	...
	$Data = array(
		'Distribute_Type'=>$_POST['Type'],
		'Distribute_Limit'=>empty($_POST['Limit'][$_POST['Type']]) ? 0 : $_POST['Limit'][$_POST['Type']],
		'Distribute_Customize'=>$_POST['Customize'],
		'HIncomelist_Open'=>$_POST['HIncomelist_Open'],
		'H_Incomelist_Limit'=>!empty($_POST['H_Incomelist_Limit'])?$_POST['H_Incomelist_Limit']:0,
		'QrcodeBg'=>$_POST['QrcodeBg'],
		'ApplyBanner'=>$_POST['ApplyBanner'],
		'Withdraw_Type'=>$_POST['DType'],
		'Withdraw_Limit'=>empty($_POST['DLimit'][$_POST['DType']]) ? 0 : $_POST['DLimit'][$_POST['DType']],
		'Withdraw_PerLimit'=>empty($_POST['PerLimit']) ? 0 : $_POST['PerLimit']
	);
	
	if($_POST['Type']==3){
		$Data["DiyMenu"] = empty($Menu) ? '' : json_encode($Menu,JSON_UNESCAPED_UNICODE);
	}
