...
if(isset($_GET["action"]))
{
	if($_GET["action"]=="del")
	{
		$Flag=$DB->Del("shop_products","Users_ID='".$_SESSION["Users_ID"]."' and Products_ID=".$_GET["ProductsID"]);
		if($Flag){
...
function get_category($catid){
	global $DB;
	$r = $DB->GetRs("shop_category","*","where Category_ID='".$catid."'");
...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div id="products" class="r_con_wrap"> 
      ...
      <a href="output.php?type=product_gross_info" class="btn_green btn_w_120">导出产品</a>
      </div>
