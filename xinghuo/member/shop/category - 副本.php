      ...
      <div class="category">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mytable">
          <tr bgcolor="#f5f5f5">
            ...
            <td align="center"><strong>上级类别</strong></td>
            <td width="60" align="center"><strong>操作</strong></td>
          </tr>
          <?php
$ListType=array(0=>"一行一列",1=>"一行两列");
$rsCategory=$DB->get("shop_category","*","where Users_ID='".$_SESSION["Users_ID"]."' order by Category_Index asc");
$cate=$DB->toArray($rsCategory);
$Menu=array();
$Menu[0]='无';
foreach($cate as $v)
{
	$Menu[$v['Category_ID']]=$v['Category_Name'];
...
?>
          <tr onMouseOver="this.bgColor='#D8EDF4';" onMouseOut="this.bgColor='';" onDblClick="location.href='category_edit.php?CategoryID=<?php echo $value["Category_ID"]; ?>'">
            ...
            <td><?php echo $Menu[$value["Category_ParentID"]]; ?></td>
