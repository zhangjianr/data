  ...
  <div class="iframe_content">
    ...
    <div id="skin" class="r_con_wrap">
      <ul>
        ...
        <?php 
		$i=0;
		$DB->get("shop_skin","*","where Skin_Status=1 and (Users_ID='' or Users_ID='".$_SESSION['Users_ID']."')  order by Skin_ID asc");
while($rsSkin=$DB->fetch_assoc()){
	$i++;
	$html = '';
	$html = $rsSkin['Users_ID']==$_SESSION['Users_ID'] ? $rsSkin['Skin_Name'] : '风格'.$i;
