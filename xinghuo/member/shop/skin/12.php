...
?>
	...
	<div id="index-h">
		...
		<div class="c"><a href="products/?IsHot=1"><img src="/static/api/shop/skin/<?php echo $rsConfig['Skin_ID'];?>/hot.jpg" /><br />热销产品</a></div>
		<div class="d"><a href="products/?IsNew=1"><img src="/static/api/shop/skin/<?php echo $rsConfig['Skin_ID'];?>/new.jpg" /><br />新品上市</a></div>
	</div>
