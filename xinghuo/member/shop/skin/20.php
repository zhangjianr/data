    ...
    <div id="home" class="r_con_wrap">
      <div class="m_lefter">
       <div id="shop_skin_index">
        ...
        <div class="index-h">
            <div class="items"><a href="cart/"><img src="/static/api/shop/skin/<?php echo $rsConfig['Skin_ID'];?>/cart_icon.png" /></a></div>
            <div class="items"><a href="category/0/"><img src="/static/api/shop/skin/<?php echo $rsConfig['Skin_ID'];?>/products_icon.png" /></a></div>
            <div class="items"><a href="category/0/?IsNew=1"><img src="/static/api/shop/skin/<?php echo $rsConfig['Skin_ID'];?>/gift_icon.png" /></a></div>
            <div class="items"><a href="member/"><img src="/static/api/shop/skin/<?php echo $rsConfig['Skin_ID'];?>/member_icon.png" /></a></div>
        </div>
        <div class="ind_wrap">
            ...
            <div class="ad_items"><div class="shop_skin_index_list" rel="edit-t05"><div class="img"></div></div></div>
                    <div class="products_list">
                            <div class="items"><a href="" >鲜花</a></div>
                            <div class="items"><a href="" >雪纺连衣裙</a></div>
                            <div class="items"><a href="" >拼接开衫</a></div>
                      </div>
