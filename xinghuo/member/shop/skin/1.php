...
if(empty($rsSkin['Home_Json'])){
	for($no=1;$no<=1;$no++){
		$json[$no-1]=array(
			...
			"ImgPath"=>$no==1?json_encode(array("/api/shop/skin/".$rsSkin['Skin_ID']."/banner.jpg")):"/api/shop/skin/".$rsSkin['Skin_ID']."/i".($no-2).".jpg",
...
?>
    ...
    <link href='/static/api/shop/skin/default/css/index.css' rel='stylesheet' type='text/css' />
