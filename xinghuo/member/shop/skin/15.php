<?php
$Dwidth = array('640','0','0');
$DHeight = array('320','0','0');
    ...
    <div id="home" class="r_con_wrap">
      ...
      <script type="text/javascript">
		var skin_index_init=function(){
			$('.addtocart_form input[type=button]').click(function(){
					var this_btn=$(this);
					this_btn.attr('disabled', true);
					ProId=this_btn.attr('data');
					$.post($('#myform_'+ProId).attr('action')+'ajax/',$('#myform_'+ProId).serialize(), function(data){
						this_btn.attr('disabled', false);
						if(data.status==1){
							window.location=$('#myform_'+ProId).attr('action');
						}
					}, 'json');
			});
		};
       ...
       <div id="shop_skin_index">
         <div class="shop_skin_index_list top_column" rel="edit-t02">
            <div class="text"></div>
        </div>
        <div class="shop_skin_index_list banner" rel="edit-t01">
            <div class="img"></div>
        </div>
        <div class="shop_skin_index_list top_column" rel="edit-t03">
            <div class="text"></div>
        </div>
       </div>
      </div>
