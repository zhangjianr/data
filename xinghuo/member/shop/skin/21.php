    ...
    <div id="home" class="r_con_wrap">
      <div class="m_lefter">
       <div id="shop_skin_index">
		...
		<div class="ind_wrap">
    	 <div class="category">
          <h3><a href="products/4687/" class="more">查看更多</a>休闲娱乐</h3>
          <div class="products">
            <div class="clear"></div>
          </div>
         </div>
         <div class="category">
          <h3><a href="products/4686/" class="more">查看更多</a>美食专区</h3>
          <div class="products">
           <div class="clear"></div>
          </div>
         </div>
         <div class="category">
          <h3><a href="products/4685/" class="more">查看更多</a>彩妆专区</h3>
          <div class="products">
           <div class="clear"></div>
          </div>
         </div>
         <div class="category">
          <h3><a href="products/4684/" class="more">查看更多</a>饰品专区</h3>
          <div class="products">
           <div class="clear"></div>
          </div>
         </div>
         <div class="category">
          <h3><a href="products/4683/" class="more">查看更多</a>箱包专区</h3>
          <div class="products">
           <div class="clear"></div>
          </div>
         </div>
         <div class="category">
          <h3><a href="products/4682/" class="more">查看更多</a>衣装专区</h3>
          <div class="products">
           <div class="clear"></div>
          </div>
         </div>
