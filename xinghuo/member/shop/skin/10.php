...
?>
    ...
    <div id="home" class="r_con_wrap">
      ...
      <script type="text/javascript">
		var skin_index_init=function(){
			$('#shop_skin_index .menu a.category').click(function(){
    ...
    <div class="menu">
    	<ul>
        	<li><a href="javascript:;" class="category">全部分类</a></li>
        	<li><a href="cart/">购物车</a></li>
        	<li><a href="category/0/?IsNew=1">最新产品</a></li>
        	<li><a href="category/0/?IsHot=1">热卖产品</a></li>
        </ul>
        <div class="clear"></div>
    </div>
    <div class="box">
