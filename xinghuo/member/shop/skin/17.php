<?php
$Dwidth = array('640','318','318','640','152','160','160','160','160','160','160');
$DHeight = array('320','318','318','320','320','160','160','160','160','160','160');
...
?>
    ...
    <div id="home" class="r_con_wrap">
      <div class="m_lefter">
        ...
        <div class="shop_skin_index_list ind_two_box" rel="edit-t04">
            <div class="img"></div>
        </div>
                ...
                <ul>
                        ...
                        <div class="shop_skin_index_list" rel="edit-t09">
                            <div class="img"></div>
                                    ...
                                    <li class="fl mar_r">
                        <div class="shop_skin_index_list" rel="edit-t10">
                            <div class="img"></div>
                        </div>
                    </li>
                                    <li class="fl">
                        <div class="shop_skin_index_list" rel="edit-t11">
                            <div class="img"></div>
                        </div>
                    </li>
                                </ul>
