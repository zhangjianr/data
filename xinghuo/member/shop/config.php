...
if($_POST)
{
	...
	$Data=array(
		...
		"ShopLogo"=>$_POST["Logo"],
		"NeedShipping"=>isset($_POST["NeedShipping"])?$_POST["NeedShipping"]:0,
		...
		"Member_Substribe"=>isset($_POST["MemberSubstribe"])?$_POST["MemberSubstribe"]:0,
		"Member_SubstribeScore"=>$_POST["MemberSubstribeScore"]
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="50%" valign="top"><h1><strong>需要物流</strong><span class="tips">（关闭后下订单无需填写收货地址）</span></h1>
              <div class="input">
                <input type="checkbox" name="NeedShipping" value="1"<?php echo empty($rsConfig["NeedShipping"])?"":" checked"; ?> />
		  ...
		  <tr>
			<td width="50%" valign="top">
            	<h1><strong>下级首次关注公众号获取积分</strong>
                <input type="checkbox" name="MemberSubstribe" value="1"<?php echo empty($rsConfig["Member_Substribe"])?"":" checked"; ?> />
                <span class="tips">开启</span></h1>
              <input type="text" class="input" name="MemberSubstribeScore" style="width:50px" value="<?php echo $rsConfig["Member_SubstribeScore"] ?>" />
            </td>
            <td width="50%" valign="top">
              &nbsp;
            </td>                          
