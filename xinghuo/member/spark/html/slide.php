			...
			<div class="iframe_content">
				...
				<div id="products" class="r_con_wrap">
					<div class="control_btn">
						<a href="?op=post" class="btn_green btn_w_120">添加幻灯</a>
					</div>
					...
					<table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
						<thead>
							<tr>
								...
								<td width="8%" nowrap="nowrap">幻灯名称</td>
								<td width="8%" nowrap="nowrap">链接</td>
								<td width="8%" nowrap="nowrap">幻灯图片</td>
								<td width="15%" nowrap="nowrap">是否显示</td>
						...
						<tbody>
							<?php
								...
								$DB->getPage("spark_slide", "*", $condition, 10);
							...
							<tr>
								...
								<td><?php echo $rsProducts["title"] ?></td>
								<td><?php echo $rsProducts["url"] ?></td>
								<td><?php echo $rsProducts["thumb"] ?></td>
								<td><?php echo $rsProducts["status"] ?></td>
								<td><?php echo date("Y-m-d H:s:i", $rsProducts["createtime"]); ?></td>
								<td class="last" nowrap="nowrap">
									<a href="slide.php?op=post&id=<?=$rsProducts["ID"] ?>">
										<img src="/static/member/images/ico/mod.gif" align="absmiddle" alt="修改" /></a>
									<a href="slide.php?op=delete&id=<?=$rsProducts["ID"] ?>" onClick="if (!confirm('删除后不可恢复，继续吗？')) { 	return false;};">
