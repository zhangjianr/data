  ...
  <div class="iframe_content">
    ...
    <div class="r_nav">
      <ul>
        ...
        <li class=""><a href="/member/wechat/spread.php">推广渠道管理</a></li>
      </ul>
    </div>
...
while($rsPmenu=$DB->fetch_assoc()){
	echo '<option value="'.$rsPmenu["Menu_ID"].'">'.$rsPmenu["Menu_Name"].'</option>';
            ...
            <div class="opt_item" id="menu1" style="display:none;">
              ...
              <select name='MaterialID'>
				...
				while($rsMaterial=$DB->fetch_assoc()){
					...
					echo '<option value="'.$rsMaterial['Material_ID'].'">'.$json['Title'].'</option>';
				}?>
				...
				while($rsMaterial=$DB->fetch_assoc()){
					...
					echo '<option value="'.$rsMaterial['Material_ID'].'">'.($rsMaterial['Material_Type']?'【多图文】':'【单图文】').$json['Title'].'</option>';
				}?>
              </select>
            ...
            <div class="opt_item" id="menu2" style="display:none;">
              <label>链接网址：</label>
              <span class="input">
              <input type="text" name="Url" value="" class="form_input" size="35" maxlength="200" />
              </span>
              <div class="clear"></div>
            </div>
            <div class="opt_item">
