        ...
        <tbody>
		  <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $_SERVER["HTTP_HOST"] ?>/api/<?php echo $_SESSION["Users_ID"] ?>/scene/
            </td>
          </tr>
          <?php
				$list_column = array();
				$i = 1;
				$DB->get("scene_category","*","where Users_ID='".$_SESSION["Users_ID"]."' order by Category_Index asc");
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $_SERVER["HTTP_HOST"] ?>/api/<?php echo $_SESSION["Users_ID"] ?>/scene/detail/<?php echo $v["Category_ID"];?>/
            </td>
          </tr>
          <?php
		  		}
