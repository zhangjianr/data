    ...
    <div class="r_con_config r_con_wrap">
      <form id="config_form">
        <table align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td valign="top"><h1><span class="fc_red">*</span> <strong>商家联系电话</strong></h1>
              <input type="text" class="input" name="BusinessPhone" value="<?php echo empty($rsConfig["BusinessPhone"]) ? "" : $rsConfig["BusinessPhone"] ?>" maxlength="20" notnull /></td>
