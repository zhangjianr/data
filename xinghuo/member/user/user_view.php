...
var level_ary=Array();
    ...
    <div id="user" class="r_con_wrap">
      <div class="control_btn"><a href="" class="btn_gray">返 回</a></div>
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        <thead>
          <tr>
            ...
            <?php echo empty($rsUser['User_From'])?'<td width="7%" nowrap="nowrap">操作</a>':'' ?> </tr>
        </thead>
        <tbody>
          <tr UserID="<?php echo $rsUser['User_ID'] ?>">
            ...
            <?php echo empty($rsUser['User_From'])?'<td nowrap="nowrap" class="last"><a href="#modpass"><img src="/static/member/images/ico/mod.gif" align="absmiddle" /></a> </td>':'' ?> </tr>
        </tbody>
      </table>
