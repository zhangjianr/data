...
foreach($dsAgentArea as $key=>$AgentArea){
	 ...
	 }else if($AgentArea['area']['area_deep'] == 2){
		$dsAgentCity[] = $AgentArea['area_name'];
	 }else{
		$dsAgentCounty[] = $AgentArea['area_name'];
	 }
	...
	<div class="container">
    	...
    	<div class="row">
             ...
             <div class="panel panel-default">
				...
				<?php elseif($dis_agent_type == 3):?>
					<h4 style="color:#F29611;">代理商类型:自由合伙人</h4>
      		  	 <?php else:?>
             ...
             <?php if($dis_agent_type == 2):?>		
				...
				<?php if(!empty($dsAgentCounty)):?>
					县代地区:<span><?=implode(',',$dsAgentCounty)?></span>	
				<?php endif;?>
