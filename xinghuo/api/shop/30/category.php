...
<div id="shop_page_contents">
  ...
  <div class="header_search" style="padding-bottom:0;">
  ...
  <div id="products">
    <div class="station" style="display:none;"><a href="<?php echo $shop_url; ?>category/0/">产品展示</a><?php echo empty($rsPCategory["Category_ID"])?'':' &gt; <a href="'.$shop_url.'category/'.$rsPCategory["Category_ID"].'/">'.$rsPCategory["Category_Name"].'</a>' ?> &gt; <a href='<?php echo $shop_url; ?>category/<?php echo $rsCategory["Category_ID"] ?>/'><?php echo $rsCategory["Category_Name"] ?></a></div>
