...
if(!empty($_GET['action'])){
    ...
    if($action == 'delete'){
        ...
        $rsOrder = $DB->getRs('user_order','Integral_Consumption,Order_Status',$condition);
        ...
        if($Flag_a&&$Flag_b)
        {
            ...
            $url = $base_url.'api/'.$UsersID.'/shop/member/status/'.$rsOrder['Order_Status'].'/';    
...
<div id="shop_page_contents">
  ...
  <div id="order_list">
<?php
$DB->get("user_order","*","where Users_ID='".$UsersID."' and User_ID='".$_SESSION[$UsersID."User_ID"]."' and Order_Status=".$Status." and Order_Type='shop' order by Order_CreateTime desc");
