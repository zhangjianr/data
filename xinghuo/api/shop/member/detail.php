  ...
  <div id="order_detail">
    <div class="item">
      <ul>
		...
		<?php }?>
		<li>订单类型: <?php echo $Order_Type; ?></li>
...
foreach($CartList as $key=>$value){
    ...
    <?php if($rsOrder["Order_Status"]==3 && $rsOrder["Is_Commit"]==0){ ?>
     <div class="backup"><a href="/api/<?php echo $UsersID ?>/shop/member/backup/<?php echo $rsOrder["Order_ID"] ?>/">去退货</a></div>
