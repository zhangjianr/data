...
function loaded () {
    ...
    <div id="option_content">
        ...
        <div id="footer_panel_content">
            <ul id="footer-panel">
                <li class="button-conteiner" style="width:100%; padding-left:52px; line-height:20px; color:#FFF; box-sizing:border-box; font-size:12px;">
					<?php if($fx_enable==1){?>
					...
					<p style="font-size:12px; color:#FFF; height:36px; overflow:hidden; line-height:17px; margin:0px; padding:5px 0px 0px 8px"><?php echo $head_name;?></p>
				</li>
                <div class="clearfix"></div>
            </ul>
        </div>
