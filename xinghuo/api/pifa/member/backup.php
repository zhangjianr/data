...
<div id="shop_page_contents">
	...
	<div id="order_detail">
		...
		<div class="item">
			...
			<div class="pro" >
				<div class="img"><a href="/api/<?=$UsersID?>/pifa/product/<?=$key?>/?wxref=mp.weixin.qq.com"><img src="<?=$v["ImgPath"]?>" height="100" width="100"></a></div>
				<dl class="info">
					<dd class="name"><a href="/api/<?=$UsersID?>/pifa/product/<?=$key?>/?wxref=mp.weixin.qq.com">
						<?=$v["ProductsName"]?>
						</a></dd>
					<dd>价格:￥
						<?=$v["ProductsPriceX"]?>
						...
						<?=$v["Qty"]?>
						=￥
						<?=$v["ProductsPriceX"]*$v["Qty"]?>
					</dd>
					<dd>
						<input type="checkbox" name="Products_ID[]" value="<?=$key?>"/>
					</dd>
				</dl>
				<div class="clear"></div>
			</div>
