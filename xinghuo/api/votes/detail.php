...
$share_title = $rsItem["Item_Title"];
$share_desc = $rsItem["Item_Title"];
$img_url = 'http://'.$_SERVER["HTTP_HOST"].($rsItem["Item_ImgPath"] ? $rsItem["Item_ImgPath"] : '/static/api/images/cover_img/votes.jpg')
?>
<!DOCTYPE html>
<html>
<head>
