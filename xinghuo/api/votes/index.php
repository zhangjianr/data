...
$share_title = $rsVotes["Votes_Title"];
$share_desc = $rsVotes["Votes_Title"];
$img_url = 'http://'.$_SERVER["HTTP_HOST"].($rsVotes["Votes_Banner"] ? $rsVotes["Votes_Banner"] : '/static/api/images/cover_img/votes.jpg');
?>
<!DOCTYPE html>
<html>
<head>
