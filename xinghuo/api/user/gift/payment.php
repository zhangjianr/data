...
<div id="shop_page_contents">
  ...
  <script language="javascript">$(document).ready(user_obj.gift_payment_init);</script>
  <div id="payment">
    <div class="i-ture">
    ...
    <form id="payment_form" action="/api/<?php echo $UsersID ?>/user/gift/ajax/">
      	<div class="i-ture">
...
if(!empty($rsPay["Payment_OfflineEnabled"])){?>
             <li>
             <a href="/api/<?=$UsersID?>/user/gift/complete_pay/huodao/<?=$OrderID?>/" class="btn btn-warning  btn-pay" id="out" data-value="线下支付"><img  src="/static/api/shop/skin/default/huodao.png" width="16px" height="16px"/>&nbsp;货到付款</a>
            </li>
    <?php }?>        

             <li>
             <a href="/api/<?=$UsersID?>/user/gift/complete_pay/money/<?=$OrderID?>/" class="btn btn-warning  btn-pay" id="money" data-value="余额支付"><img  src="/static/api/shop/skin/default/money.jpg"  width="16px" height="16px"/>&nbsp;余额支付</a>
            </li>	
            </ul>
