...
<div id="footer_user"> <a href="/api/<?php echo $UsersID ?>/shop/" class="m5">首页</a> <a href="/api/<?php echo $UsersID ?>/user/" class="m0">会员卡</a> <a href="/api/<?php echo $UsersID ?>/user/message/" class="m1">消息
  ...
  </a> <a href="/api/<?php echo $UsersID ?>/user/my/" class="m4">我的</a> </div>
