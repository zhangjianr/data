...
<div id="card">
  ...
  <div class="list_item">
    ...
    <a href="/api/<?php echo $UsersID ?>/user/my/profile/" class="item item_3"><span class="ico"></span>修改我的资料<span class="jt"></span></a>
    <div class="dline"></div>    
    <a href="/api/<?php echo $UsersID ?>/shop/" class="item item_4"><span class="ico"></span>进入商城<span class="jt"></span></a>
     <a href="/api/<?=$UsersID?>/shop/member/status/1/" class="item item_4"><span class="ico"></span>我的商城订单<span class="jt"></span></a>
	 <a href="/api/<?=$UsersID?>/user/kanjia_order/" class="item item_4"><span class="ico"></span>我的砍价订单<span class="jt"></span></a>
    <a href="/api/<?php echo $UsersID ?>/user/gift/" class="item item_5"><span class="ico"></span>积分兑换礼品<span class="jt"></span></a>
    <div class="dline"></div>
