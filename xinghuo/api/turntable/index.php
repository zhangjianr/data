...
var start=false;
var ajax_url = "http://<?php echo $_SERVER["HTTP_HOST"];?>/api/<?php echo $UsersID;?>/turntable/";
...
?>
	...
	<script language="javascript">
		var share_config = {
		   appId:"<?php
    echo $share_user["Users_WechatAppId"]; ?>",		   
		   timestamp:<?php
    echo $timestamp; ?>,
		   nonceStr:"<?php
    echo $noncestr
...
?>",
    ...
    echo $signature; ?>",
		   title:'<?php
    echo $rsTurntable['Turntable_Title']; ?>',
		   desc:'',
		   img_url:'http://<?php
    echo $_SERVER["HTTP_HOST"]; ?>/static/api/images/global/share/web.jpg'
		};
